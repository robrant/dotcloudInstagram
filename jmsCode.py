...
class amqpHandler():
    """
    In here should be a class that uses an amqp python module to connect
    and makes it easy to send a message
    
    Should also add one for getting messages off the queue.
    """
    def __init__(self):
        '''    '''
